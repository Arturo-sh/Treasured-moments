...
if (mysqli_num_rows($result_total_logs) > 0) {
...
<nav aria-label="Page navigation example" class="mt-3">
    <ul class="pagination justify-content-center">
        <li class="page-item <?php if ($_GET['pag'] == 1) echo 'disabled'; ?>"><a class="page-link" href="logs_acceso/<?php echo $_GET['pag']-1; ?>">Anterior</a></li>
        <li class='page-item disabled'><span class='page-link'><-></span></li>
        <li class="page-item <?php if ($_GET['pag'] == $num_pages || $num_pages == null) echo 'disabled'; ?>"><a class="page-link" href="logs_acceso/<?php echo $_GET['pag']+1; ?>">Siguiente</a></li>
    </ul>
</nav>
